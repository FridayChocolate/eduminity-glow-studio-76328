  ...
  return (
    <section className="relative h-64 overflow-hidden rounded-xl mb-8 bg-gradient-hero dark:shadow-glow-teal">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent dark:from-neon-teal dark:via-neon-violet dark:to-neon-magenta drop-shadow-lg">
